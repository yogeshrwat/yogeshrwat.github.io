                ...
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    >
                        ...
                        <motion.div
                            ...
                            className="relative w-full max-w-[500px] h-32 md:max-w-[800px] md:h-48 mb-6"
                        >
                            <Image
                                src="/images/gptt.png"
                        ...
                        <motion.div
                            ...
                            className="text-base md:text-lg text-gray-400 font-normal leading-relaxed tracking-normal max-w-xl font-sans -mt-10 md:-mt-12 text-justify"
                        >
